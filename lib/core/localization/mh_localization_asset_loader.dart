...
/// Monday Hero uses easy_localization package and MHLocalizationAssetLoader
/// as a standard.
///
...
/// ```
///
/// 2. Declare your assets directories as follows in pubspec.yaml:
///
/// ```yaml
/// flutter:
//   assets:
  ...
  Future<Map<String, dynamic>?> load(String path, Locale locale) async {
    ...
    try {
      ...
      EasyLocalization.logger
          .debug('App localization file is not found in $path');
    }

    try {
      generatedLocale =
          json.decode(await rootBundle.loadString(generatedLocalePath));
    } catch (_) {
      generatedLocale = {};
      EasyLocalization.logger
          .debug('Generated localization file is not found in $path');
    }
